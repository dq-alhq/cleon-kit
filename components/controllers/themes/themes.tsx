...
import { type VariablesPresetProps } from './variables-preset'
                        ...
                        <Popover>
                            ...
                            <Popover.Content placement='right'>
                                <Popover.Header>
                                    ...
                                    <Popover.Description>Customize your theme</Popover.Description>
                                    <Popover.Close
                                        variant='ghost'
                                        size='icon'
                                ...
                                <Popover.Body className='mt-2 space-y-2'>
                                    ...
                                    <Tabs>
                                        ...
                                        <Tabs.Content id='light' className='grid grid-cols-2 gap-1'>
                                        ...
                                        <Tabs.Content id='dark' className='grid grid-cols-2 gap-1'>
...
const ColorPick = ({ variable, onChange, label, ...props }: ColorPickProps) => {
    return (
        <ColorPicker
            className='border'
            label={label}
