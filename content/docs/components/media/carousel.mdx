...
<Demo center component='media/carousel-demo' />
...
<Demo center component='media/carousel-with-collection-demo' />
...
<Demo center component='media/carousel-orientation-demo' />

## Options

You want to loop, or align the carouse, don't worry, you can do it with the `opts` prop.

<Demo center component='media/carousel-options-demo' />
...
<Demo center component='media/carousel-autoplay-demo' />
...
<Demo center component='media/carousel-api-demo' />
