...
<Demo component='statuses/progress-circle-demo' />
...
<Demo component='statuses/progress-circle-indeterminate-demo' />

## Custom Size

You can customize the size of the progress circle by using className with tailwind classes or style props.

<Demo component='statuses/progress-circle-custom-size-demo' />

## Controlled

You can control the progress circle by using the `value` prop.

<Demo component='statuses/progress-circle-controlled-demo' />
...
<Demo component='buttons/button/button-pending-demo' />

## Custom Color

The progress circle can be customized with the `color` prop.

<Demo component='statuses/progress-circle-color-demo' />
