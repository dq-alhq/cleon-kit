...
<Demo component='pickers/multiple-select/multiple-select-demo' />
...
<Demo component='pickers/multiple-select/multiple-select-min-max-demo' />

## Variant

By default, the multiple select component uses the `primary` variant. But it has a `secondary` variant as well.

<Demo component='pickers/multiple-select/multiple-select-variant-demo' />
...
<Demo component='pickers/multiple-select/multiple-select-controlled-demo' />

## Disabled

When the component is disabled, it prevents the user from adding or removing tags.

<Demo component='pickers/multiple-select/multiple-select-disabled-demo' />
