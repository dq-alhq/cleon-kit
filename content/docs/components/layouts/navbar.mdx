...
<Demo component="layouts/navbar/navbar-basic-demo" />
...
<Demo component="layouts/navbar/navbar-creating-demo" />
...
<Demo component="layouts/navbar/navbar-logo-demo" />

## Current
Highlight the current page in the navbar for better navigation clarity.
<Demo component="layouts/navbar/navbar-current-demo" />
...
<Demo component="layouts/navbar/navbar-floating-demo" />
...
<Demo className='rounded-lg overflow-hidden' component="layouts/navbar/navbar-variant-demo" />
...
<Demo component="layouts/navbar/navbar-icon-demo" />

## Disabled
Disable individual navbar items when needed.
<Demo component="layouts/navbar/navbar-disabled-demo" />
