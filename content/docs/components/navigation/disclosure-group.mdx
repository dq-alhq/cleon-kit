...
<Demo className='flex-1' component='navigation/disclosure-group/disclosure-group-demo' />
...
<Demo component='navigation/disclosure-group/disclosure-group-default-expand-demo' />

## Allow Multiple Expanded

Allow multiple sections to be expanded at once by using the `allowsMultipleExpanded` prop.

<Demo component='navigation/disclosure-group/disclosure-group-allow-multiple-expand-demo' />

## Border Hidden

Eliminate the border between sections by using the `hideBorder` prop.

<Demo component='navigation/disclosure-group/disclosure-group-border-hidden-demo' />

## Hide Indicator

Eliminate the visual indicator (arrow key) by using the `hideIndicator` prop.

<Demo component='navigation/disclosure-group/disclosure-group-hide-indicator-demo' />
...
<Demo component='navigation/disclosure-group/disclosure-group-hide-everything-demo' />

## Disabled

You can disabled specific sections by using the `isDisabled` props to the item.

<Demo component='navigation/disclosure-group/disclosure-group-disabled-demo' />
